...
// ROS nodehandle
ros::NodeHandle nh;
char topic_name_left_buffer[10] = "n/a";
char * topic_name_left_ptr[1] = {topic_name_left_buffer};

char topic_name_right_buffer[10] = "n/a";
...
// Thanks Ankita aka captain obvious
  ...
  ros::Publisher encoder_cui_left(topic_name_buffer, &drive_encoder_left_msg_stamped);
  nh.advertise(encoder_left);

  ros::Publisher encoder_cui_right(topic_name_buffer, &drive_encoder_right_msg_stamped);
  ...
  while (1)
  {
   ...
   /* Get direction (1 = forward, -1 = backward). */
    ...
    driver_encoder_left_msg_stamped.header.stamp=nh.now();
